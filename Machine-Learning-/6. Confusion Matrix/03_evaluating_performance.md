...
> - In `sklearn`, you use `from sklearn.metrics import classification_report` to instantly generate a table containing Precision, Recall, F1-Score, and Accuracy for all your classes!
